...
const renderList = [
    ...
    /* 12: emergency_stop */ (ctx, cx, cy) => {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            ctx.beginPath(); ctx.arc(0, 0, 14, -Math.PI*0.2, Math.PI*0.1); ctx.stroke();
            ctx.fillStyle='rgba(255,255,255,0.7)'; ctx.beginPath(); ctx.moveTo(12, 4); ctx.lineTo(15, -2); ctx.lineTo(18, 5); ctx.fill();
            ctx.restore();
        }
        ctx.restore();
    }
